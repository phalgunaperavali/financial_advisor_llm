...
This project is currently maintained by Phalguna Peravali, a Software Engineer with 5+ years of professional experience in full-stack development, microservices architecture, and cloud technologies. Phalguna is proficient in a wide range of technologies including JAVA 11, Python, Spring Boot, and Angular, with a track record of optimizing system performance and modernizing legacy applications.

- **Email**: phalgunaperavali@gmail.com
- **LinkedIn**: [Phalguna Peravali](https://www.linkedin.com/in/phalguna)
- **GitHub**: [Phalguna Peravali](https://github.com/phalgunaperavali)